...
A verified ask-user review gate already relayed to the captain uses that same bounded hold mechanism through its firstmate-owned `state/<id>.held-for-captain` marker.
