...
state/               volatile runtime signals; gitignored
  watchdog/          watchdog metrics and per-task compact, clear, and successor markers; generated by fm-watch.sh / fm-watchdog-lib.sh
...
That path can steer compact/clear, spawn a successor from a handoff, or halt on unproven successor spawn.
