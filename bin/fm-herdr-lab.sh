...
# Every Herdr call made here carries a leading --session <session> global flag
# (herdr 0.7.3 accepts the trailing spelling syntactically but `pane run` does
# not execute under it; docs/herdr-backend.md "Session targeting").
