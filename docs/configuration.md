...
FM_PROC_ROOT_OVERRIDE (test-only proc root for Linux identity), FM_GUARD_GRACE=300      # seconds before guard warnings, arm health checks, and the primary turn-end guard treat a watcher beacon as stale
